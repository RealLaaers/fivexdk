...
if GetConvar('voice_useNativeAudio', 'false') == 'true' then
    ...
    Cfg.voiceModes = {
        { 1.5, "" }, -- Whisper speech distance in gta distance units
        { 3.0, "" }, -- Normal speech distance in gta distance units
        { 6.0, "" } -- Shout speech distance in gta distance units
    }
else
    Cfg.voiceModes = {
        { 3.0,  "" }, -- Whisper speech distance in gta distance units
        { 7.0,  "" }, -- Normal speech distance in gta distance units
