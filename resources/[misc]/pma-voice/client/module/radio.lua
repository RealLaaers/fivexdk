	...
	if not radioPressed and radioEnabled then
		if radioChannel > 0 then
			...
			--if GetConvarInt('voice_enableRadioAnim', 0) == 1 and not (GetConvarInt('voice_disableVehicleRadioAnim', 0) == 1 and IsPedInAnyVehicle(PlayerPedId(), false)) and not disableRadioAnim then
				...
				AttachEntityToEntity(object, PlayerPedId(), GetPedBoneIndex(PlayerPedId(), 18905), 00.13555, 0.04555, -0.0120, 130.0, -38.0, 170.0, true, true, false, true, 1, true) -- 0x49D9
				end
			--end
...
if gameVersion == 'fivem' then
	RegisterKeyMapping('+radiotalk', 'Snak over Radio', 'keyboard', GetConvar('voice_defaultRadio', 'LMENU'))
end
