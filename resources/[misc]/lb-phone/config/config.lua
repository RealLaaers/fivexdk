...
Config.PhoneNumber = {}
Config.PhoneNumber.Format = "" -- Don't touch unless you know what you're doing. IMPORTANT: The sum of the numbers needs to be equal to the phone number length + prefix length
...
Config.AutoFollow.Birdy.Enabled = false
...
Config.AutoFollow.InstaPic.Enabled = false
...
Config.AutoFollow.Trendy.Enabled = false
...
Config.BirdyTrending.Enabled = false -- show trending hashtags?
