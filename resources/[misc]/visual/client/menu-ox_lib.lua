if Config.Menu == "ox_lib" then
    if lib then
        ...
        lib.registerMenu({
            ...
            position = "top-right",
            options = {
                { label = "Skift FPS settings", args = { menu = Config.fpsMenu } },
                { label = "Vælg visuelle effekter", args = { menu = Config.visualMenu } },
                { label = "Vælg belysning (køretøjer)", args = { menu = Config.lightsMenu } }
            }
        },
        function(_, _, args)
            if args.menu then
        ...
        lib.registerMenu({
            ...
            title = "Visuel modifikationsmenu",
            position = "top-right",
        ...
        local function generateLightButton(light, settingName, time)
            return {
                ...
                args = { onClick = function(selected)
                    ...
                    lib.hideMenu()
                    local input = lib.inputDialog("FiveX", {
