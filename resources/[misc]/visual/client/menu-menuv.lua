if Config.Menu == "menuv" then
    if MenuV then
        Config.mainMenu = MenuV:CreateMenu("Relentless Arena", "Main Menu", "centerright", 31, 255, 34, "size-150", "default", "menuv", "x-visual_main_menu", "default")
        Config.fpsMenu = MenuV:CreateMenu("Relentless Arena", "FPS Booster Menu", "centerright", 31, 255, 34, "size-150", "default", "menuv", "x-visual_fps_menu", "default")
        Config.visualMenu = MenuV:CreateMenu("Relentless Arena", "Visual Modifier Menu", "centerright", 31, 255, 34, "size-150", "default", "menuv", "x-visual_visual_menu", "default")
        Config.lightsMenu = MenuV:CreateMenu("Relentless Arena", "Vehicle Lights Menu", "centerright", 31, 255, 34, "size-150", "default", "menuv", "x-visual_light_menu", "default")
        Config.dayLightsMenu = MenuV:CreateMenu("Relentless Arena", "Vehicle Lights Menu (DAY)", "centerright", 31, 255, 34, "size-150", "default", "menuv", "x-visual_day_light_menu", "default")
        Config.nightLightsMenu = MenuV:CreateMenu("Relentless Arena", "Vehicle Lights Menu (NIGHT)", "centerright", 31, 255, 34, "size-150", "default", "menuv", "x-visual_night_light_menu", "default")
