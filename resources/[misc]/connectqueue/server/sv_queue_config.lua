...
Config.Priority = {
    ["steam:1100001348e71f0"] = 100, -- Grisen
}
...
Config.Language = {
    ...
    err = "\xE2\x9D\x97[Queue] Der var en fejl",
    pos = "\xF0\x9F\x90\x8CDu er nr. %d/%d i køen \xF0\x9F\x95\x9C%s",
    ...
    steam = "\xE2\x9D\x97 [Queue] Fejl: Steam skal køre!"
}