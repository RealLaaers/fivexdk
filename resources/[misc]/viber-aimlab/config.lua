...
Config.Framework = "esx"  -- | # | You can specify this part as "oldesx" or "esx" or "qb" or "oldqb"
...
Config.Interaction_Type = "command"  -- | # | You can specify this part as "npc" or "command" or "trigger"
