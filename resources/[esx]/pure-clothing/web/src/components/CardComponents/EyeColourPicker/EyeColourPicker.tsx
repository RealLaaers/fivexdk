...
import eyeColours from '../../../menus/eyeColours';
import '../ColourPicker/ColourPicker.scss';
import '../CardComponents.scss';
import 'react-slidedown/lib/slidedown.css';
import { setEyeColour } from '../../../store/features/createChar/eyesSlice';

const EyeColourPicker: React.FC = () => {
  const [expanded, setExpanded] = useState(false);
  // const [currentClicked, setCurrentClicked] = useState(0);
  const eyeColour = useAppSelector((state) => state.eyes.eyeColour);
      ...
      <SlideDown className="my-dropdown-slidedown">
        {expanded ? (
          <div className="margin-top">
            ...
            >
              <h5>{language.popouts.eyeColour}</h5>
              <svg
                viewBox="0 0 24 24"
                fill="currentColor"
                height="1em"
                ...
                return (
                  <div
                    ...
                    onClick={() => {
                      ...
                      // sendNui('setEyeColour', colour.id);
                      dispatch(setEyeColour(colour.id));
                    }}
                  >
                    {eyeColour === colour.id ? (
                      <svg
...
export default EyeColourPicker;
