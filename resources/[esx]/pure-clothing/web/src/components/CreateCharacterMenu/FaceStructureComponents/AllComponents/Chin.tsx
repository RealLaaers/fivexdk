...
const Chin: React.FC = () => {
  ...
  const state = useAppSelector((state) => state.chin);
  const config = useAppSelector((state) => state.config.config);

  if (!config.nui['sections']['faceStructure'].chin) {
    return null;
  }
  ...
  return (
    ...
    >
      ...
      >
        <h1>{language.menus.createCharacter.chinTitle}</h1>
        <p>
          <svg
            viewBox="0 0 512 512"
            fill="currentColor"
        ...
        <div className="sliderRow">
          ...
          <Slider
            ...
            onChange={(e: any, value, activeThumb) => {
              handleSliderChange(value, 'chin-bone-depth');
            }}
          />
        </div>
        <div className="sliderRow">
          ...
          >
            {language.menus.createCharacter.general.boneLength}
          </h2>
          <Slider
            style={{ width: '12em' }}
            size="medium"
            ...
            max={100}
            onChange={(e: any, value, activeThumb) => {
              handleSliderChange(value, 'chin-bone-length');
            }}
          />
        </div>
        <div className="sliderRow">
          ...
          <Slider
            ...
            max={100}
            onChange={(e: any, value, activeThumb) => {
              handleSliderChange(value, 'chin-bone-shape');
            }}
          />
        </div>
        <div className="sliderRow">
          ...
          >
            {language.menus.createCharacter.general.boneHole}
          </h2>
          <Slider
            style={{ width: '12em' }}
            size="medium"
            ...
            max={100}
            onChange={(e: any, value, activeThumb) => {
              handleSliderChange(value, 'chin-bone-hole');
            }}
          />
        </div>
      </ThemeProvider>
