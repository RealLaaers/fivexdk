...
export const helmetsSlice = createSlice({
  name: 'helmets',
  initialState,
  reducers: {
    setHelmetsForFirstTime: (state, action: PayloadAction<number>) => {
      state.baseValue1 = action.payload;
    },
    setHelmetsBaseValue1: (state, action: PayloadAction<number>) => {
      if (action.payload == 0) {
        state.baseValue1 = 0;
        return;
      }
      ...
      sendNui('setAppearance', { name: 'helmets', value: state.baseValue1 });
    },
    setHelmetsMaxValue1: (state, action: PayloadAction<number>) => {
      state.maxValue1 = action.payload;
    },
    setHelmetsBaseValue2: (state, action: PayloadAction<number>) => {
      if (action.payload == 0) {
        state.baseValue2 = 0;
        return;
      }
    ...
    setHelmetsMaxValue2: (state, action: PayloadAction<number>) => {
      state.maxValue2 = action.payload;
    },
    setHelmetsBaseValue1ByInput: (state, action: PayloadAction<number>) => {
      if (action.payload > 0) {
    ...
    setHelmetsBaseValue2ByInput: (state, action: PayloadAction<number>) => {
      if (action.payload > 0) {
