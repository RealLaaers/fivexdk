...
export const glassesSlice = createSlice({
  ...
  initialState,
  reducers: {
    setGlassesForFirstTime: (state, action: PayloadAction<number>) => {
      state.baseValue1 = action.payload;
    },
    setGlassesBaseValue1: (state, action: PayloadAction<number>) => {
      if (action.payload == 0) {
        state.baseValue1 = 0;
        return;
      }
      ...
      sendNui('setAppearance', { name: 'glasses', value: state.baseValue1 });
    },
    setGlassesMaxValue1: (state, action: PayloadAction<number>) => {
      state.maxValue1 = action.payload;
    },
    setGlassesBaseValue2: (state, action: PayloadAction<number>) => {
      if (action.payload == 0) {
        state.baseValue2 = 0;
        return;
      }
    ...
    setGlassesMaxValue2: (state, action: PayloadAction<number>) => {
      state.maxValue2 = action.payload;
    },
    setGlassesBaseValue1ByInput: (state, action: PayloadAction<number>) => {
      if (action.payload > 0) {
    ...
    setGlassesBaseValue2ByInput: (state, action: PayloadAction<number>) => {
      if (action.payload > 0) {
